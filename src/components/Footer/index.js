    ...
    <footer className="page-footer white">
        <div className="container">
            ...
            <div className="col l4 offset-l2 s12">
                ...
                <ul>
                <li><a className="blue-grey-text text-darken-4" href="https://spclk.github.io/blob/master/resume.pdf">Resume</a></li>
        ...
        <div className="footer-copyright">
            ...
            2021 Konstantin Alekseev. Developed with <a href="https://reactjs.org/" className="blue-grey-text text-darken-1">React</a> and <a href="http://react-materialize.github.io/react-materialize/?path=/story/react-materialize--welcome" className="blue-grey-text text-darken-1">Materialize</a>.
            </div>
        </div>
   </footer>
  );
